<template>
  <div class="page-complain">
    <Index-header :isFixed="true"></Index-header>
    <Nav :navList="navList" :linkUrl="'/complain'" :queryFirstPro="'type'" :queryObject="{query: $route.query.query}"></Nav>
    <div class="common-container" ref="complain">
      <Content
...
import Content from '~/components/complain/content';
